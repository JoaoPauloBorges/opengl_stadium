...
{
   /*Vetor de caracteres criado para remover os avisos de conversão invalidar String>char
   By: Morrice Benigno*/
   char textoErro[10][128]={
	   "8-bit colour no longer supported",    //0
	   "Unsupported RGB format",              //1
	   "Must be LUMINANCE or ALPHA greyscale",//2
	   "Unsupported compressed RGB format",   //3
	   "File not found"};  					  //4
	   //
   FILE   *file;
   ...
   {
   	tgaError ( textoErro[4], file_name, file, p );
      return 0;
   }
   ...
   {
      case 1 :
         tgaError ( textoErro[0], file_name, file, p );
         return 0;
      ...
      case 2 :
         if ( p->info.pixel_depth == 24 )
	      ...
	      {
         	tgaError ( textoErro[1], file_name, file, p );
         	return 0;
         }
         break;
      ...
      case 3 :
         if ( mode&TGA_LUMINANCE )
	      ...
	      {
         	tgaError ( textoErro[2], file_name, file, p );
				return 0;
         }
         break;
      ...
      case 10 :
         if ( p->info.pixel_depth == 24 )
	      ...
	      {
         	tgaError ( textoErro[3], file_name, file, p );
         	return 0;
         }
   }
