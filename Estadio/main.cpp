...
void initTexture (void){
	...
	tgaLoad  ( "texturas/campo.tga", &temp_image0, TGA_FREE | TGA_LOW_QUALITY );
	texture_id[1] = 1001;	
	glBindTexture ( GL_TEXTURE_2D, texture_id[1] );
	tgaLoad  ( "texturas/pilastra.tga", &temp_image0, TGA_FREE);
	texture_id[2] = 1002;	
	glBindTexture ( GL_TEXTURE_2D, texture_id[2] );
	tgaLoad  ( "texturas/teto.tga", &temp_image0, TGA_FREE);
	texture_id[3] = 1003;
	glBindTexture ( GL_TEXTURE_2D, texture_id[3] );
	tgaLoad  ( "texturas/chao.tga", &temp_image0, TGA_FREE);
	texture_id[4] = 1004;
	glBindTexture ( GL_TEXTURE_2D, texture_id[4] );
	tgaLoad  ( "texturas/sky.tga", &temp_image0, TGA_FREE);
	texture_id[5] = 1005;
	glBindTexture ( GL_TEXTURE_2D, texture_id[5] );
	tgaLoad  ( "texturas/contencao.tga", &temp_image0, TGA_FREE);
	texture_id[6] = 1006;
	glBindTexture ( GL_TEXTURE_2D, texture_id[6] );
	tgaLoad  ( "texturas/telao.tga", &temp_image0, TGA_FREE);
	texture_id[7] = 1007;
	glBindTexture ( GL_TEXTURE_2D, texture_id[7] );
	tgaLoad  ( "texturas/faixav.tga", &temp_image0, TGA_FREE);
}
